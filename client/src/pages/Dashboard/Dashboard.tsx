...
const gradients: Record<string, string> = {
  members: "linear-gradient(135deg,rgb(47, 143, 9) 0%,rgb(75, 162, 118) 100%)",
  revenue: "linear-gradient(135deg,rgb(162, 25, 177) 0%, #f5576c 100%)",
  attendance: "linear-gradient(135deg,rgb(7, 95, 172) 0%, #00f2fe 100%)",
  expiring: "linear-gradient(135deg,rgb(168, 16, 62) 0%, #fee140 100%)",
  equipment: "linear-gradient(135deg,rgb(53, 9, 156) 0%, #fbc2eb 100%)",
  totalMembers:
    "linear-gradient(135deg,rgb(143, 72, 7) 0%,rgb(214, 192, 117) 100%)",
};
  ...
  const statCards = [
    {
      ...
      bg: gradients.members,
    },
    {
      title: "Monthly Revenue",
      value: `Rs.${(summary?.monthlyRevenue ?? 0).toLocaleString()}`,
      bg: gradients.revenue,
    },
    {
      title: "Today's Attendance",
      value: summary?.todayAttendance ?? 0,
      bg: gradients.attendance,
    },
    {
      title: "Expiring This Week",
      value: summary?.expiringThisWeek ?? 0,
      bg: gradients.expiring,
    },
    {
      title: "Total Equipment",
      value: summary?.totalEquipment ?? 0,
      bg: gradients.equipment,
    },
    {
      title: "Total Members",
      value: summary?.totalMembers ?? 0,
      bg: gradients.totalMembers,
    },
  ];
            ...
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  ...
                  dataKey="count"
                  nameKey="shift"
                  label={({ shift, count }: any) => `${shift}: ${count}`}
                >
